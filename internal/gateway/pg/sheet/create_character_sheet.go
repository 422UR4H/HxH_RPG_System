...
func (r *Repository) CreateCharacterSheet(
	...
	const sheetQuery = `
		INSERT INTO character_sheets (
			...
			vitality_exp, energy_exp, defense_exp, push_exp, grab_exp, carry_exp, quickness_exp, accelerate_exp, brake_exp,
	...
	err = tx.QueryRow(ctx, sheetQuery,
		...
		m.VitalityExp, m.EnergyExp, m.DefenseExp, m.PushExp, m.GrabExp, m.CarryExp, m.QuicknessExp, m.AccelerateExp, m.BrakeExp,
...
func charSheetToModel(sheet *sheetEntity.CharacterSheet) *model.CharacterSheet {
	...
	return &model.CharacterSheet{
		...
		QuicknessExp:   physSkills[enum.Quickness].GetExpPoints(),
